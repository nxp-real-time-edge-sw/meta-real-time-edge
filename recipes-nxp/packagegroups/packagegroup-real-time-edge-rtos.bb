...
heterogeneous-multicore-examples:append:mx8mp-nxp-bsp = " lwip-ping-ca rpmsg-str-echo-ca rpmsg-str-echo-ca-zephyr rpmsg-str-echo-cm "
...
heterogeneous-multicore-examples:append:imx93evk = " rt-latency-ca rt-latency-ca-zephyr rpmsg-str-echo-ca rpmsg-str-echo-ca-zephyr "
heterogeneous-multicore-examples:append:imx93evk = " rpmsg-pingpong-master-ca rpmsg-pingpong-remote-ca "
...
heterogeneous-multicore-examples:append:imx93-14x14-lpddr4x-evk = " rt-latency-ca rt-latency-ca-zephyr rpmsg-str-echo-ca rpmsg-str-echo-ca-zephyr "
heterogeneous-multicore-examples:append:imx93evk-14x14-lpddr4x-evk = " rpmsg-pingpong-master-ca rpmsg-pingpong-remote-ca "
heterogeneous-multicore-examples:append:imx943-19x19-lpddr4-evk = " hmc-tools "
heterogeneous-multicore-examples:append:imx943-19x19-lpddr5-evk = " hmc-tools "
...
heterogeneous-multicore-examples:append:imx91-9x9-lpddr4-qsb = " hello-world-ca-zephyr hello-world-ca rt-latency-ca rt-latency-ca-zephyr hmc-tools "
heterogeneous-multicore-examples:append:imx91-11x11-lpddr4-evk = " hello-world-ca-zephyr hello-world-ca rt-latency-ca rt-latency-ca-zephyr hmc-tools "
