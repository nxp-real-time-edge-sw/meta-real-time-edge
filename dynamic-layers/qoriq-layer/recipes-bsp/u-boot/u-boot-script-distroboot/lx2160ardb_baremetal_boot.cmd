...
cpu 4 release ${baremetal_addr};
cpu 5 release ${baremetal_addr};
cpu 6 release ${baremetal_addr};
cpu 7 release ${baremetal_addr};
cpu 8 release ${baremetal_addr};
cpu 9 release ${baremetal_addr};
cpu 10 release ${baremetal_addr};
cpu 11 release ${baremetal_addr};
cpu 12 release ${baremetal_addr};
cpu 13 release ${baremetal_addr};
cpu 14 release ${baremetal_addr};
cpu 15 release ${baremetal_addr};
