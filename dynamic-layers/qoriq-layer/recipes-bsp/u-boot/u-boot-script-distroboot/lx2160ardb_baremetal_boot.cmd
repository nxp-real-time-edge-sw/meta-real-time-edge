...
cpu 4 start ${baremetal_addr};
cpu 5 start ${baremetal_addr};
cpu 6 start ${baremetal_addr};
cpu 7 start ${baremetal_addr};
cpu 8 start ${baremetal_addr};
cpu 9 start ${baremetal_addr};
cpu 10 start ${baremetal_addr};
cpu 11 start ${baremetal_addr};
cpu 12 start ${baremetal_addr};
cpu 13 start ${baremetal_addr};
cpu 14 start ${baremetal_addr};
cpu 15 start ${baremetal_addr};
