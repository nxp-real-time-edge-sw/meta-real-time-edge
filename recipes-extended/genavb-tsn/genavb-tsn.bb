...
# Add build and runtime dependency for libbpf and libxdp: for i.MX8, i.MX93, i.MX95, i.MX8DXL and i.MX943 SoCs
...
ENDPOINT_TSN_STACK_DEPS:mx95-nxp-bsp  = "libbpf libxdp"
ENDPOINT_TSN_STACK_DEPS:mx8dxl-nxp-bsp  = "libbpf libxdp"
ENDPOINT_TSN_STACK_DEPS:mx943-nxp-bsp  = "libbpf libxdp"

# Add build and runtime dependency for libopen62541: for i.MX8MP, i.MX93, i.MX95, i.MX8DXL and i.MX943 SoCs
ENDPOINT_TSN_APPS_DEPS = ""
ENDPOINT_TSN_APPS_DEPS:mx8mp-nxp-bsp   = "libopen62541"
ENDPOINT_TSN_APPS_DEPS:mx93-nxp-bsp  = "libopen62541"
ENDPOINT_TSN_APPS_DEPS:mx95-nxp-bsp  = "libopen62541"
ENDPOINT_TSN_APPS_DEPS:mx8dxl-nxp-bsp  = "libopen62541"
ENDPOINT_TSN_APPS_DEPS:mx943-nxp-bsp  = "libopen62541"

OPCUA_SUPPORT ?= "0"
OPCUA_SUPPORT:mx8mp-nxp-bsp = "1"
OPCUA_SUPPORT:mx93-nxp-bsp = "1"
OPCUA_SUPPORT:mx95-nxp-bsp = "1"
OPCUA_SUPPORT:mx8dxl-nxp-bsp = "1"
OPCUA_SUPPORT:mx943-nxp-bsp = "1"
